        ...
        PseudoInfiniteViewport.Pannable
{
    ...
    public void paintComponent(Graphics g)
    {
        ...
        try {
        	img = ImageIO.read(new File("chessBoard.jpg"));
        } catch (IOException e) {
        	
        }
        g2.drawImage(img,insets.left,insets.top, numCols  *  (cellSize  +  1)  +  1, 
        numRows * (cellSize + 1) + 1, 0, 0, img.getWidth(),img.getHeight(), null);
